...
This project builds a **Machine Learning model** to recommend workout routines based on:

- Gender
- Fitness Goal (Muscle Gain / Fat Burn)
- BMI Category

The model is trained using a **Random Forest Classifier** and exported for **mobile (Flutter) integration**.
...
## 🚀 Model Output
The model predicts the best **exercise schedule** for a user based on personal attributes.
